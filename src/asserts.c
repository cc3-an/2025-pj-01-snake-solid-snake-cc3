...
/**
 * Retorna true si la variable actual es igual a true
 * De lo contrario, va a retornar false con un mensaje, por ejemplo:
...
/**
 * Retorna true si la variable actual es igual a false
 * De lo contrario, va a retornar false con un mensaje, por ejemplo:
...
/**
 * Retorna true si la variable expected es igual a la variable actual (char)
 * De lo contrario, va a retornar false con un mensaje, por ejemplo:
...
/**
 * Retorna true si la variable expected es igual a la variable actual (int)
 * De lo contrario, va a retornar false con un mensaje, por ejemplo:
 * "Assertion error: expected (msg) to be (expected), but got (actual)"
*/
...
/**
 * Retorna true si la variable expected es igual a la variable actual (unsigned int)
 * De lo contrario, va a retornar false con un mensaje, por ejemplo:
 * "Assertion error: expected (msg) to be (expected), but got (actual)"
*/
...
/**
 * Retorna true si la variable expected es igual a la variable actual (bool)
 * De lo contrario, va a retornar false con un mensaje, por ejemplo:
 * "Assertion error: expected (msg) to be (expected), but got (actual)"
*/
...
// Nota: esta funcion solo funciona para estados creados desde create_default_state.
bool assert_state_equals(game_state_t* expected, game_state_t* actual) {
  // Verificar que el width y height sean iguales
  ...
  // Verificar que los tableros sean iguales
  ...
  // Verificar que num_snakes sean iguales
  if (!assert_equals_unsigned_int("number of snakes", expected->num_snakes, actual->num_snakes)) {
    return false;
  }

  // Verificar que las coordenadas de snake y live sean iguales
  // Nota: este codigo verifica todas las snakes, por lo que habria errores si
  // state->snakes no esta reservado en memoria correctamente.
